    ...
    public function add_custom_taxonomy(): void
    {
        $args = [
            ...
            'labels' => [
                ...
                'popular_items'              => __( 'Popular class_plural_upper_name', '{{ plugin_slug }}' ),
                'separate_items_with_commas' => __( 'Separate class_plural_upper_name with Commas', '{{ plugin_slug }}' ),
                'add_or_remove_items'        => __( 'Add or remove class_plural_upper_name', '{{ plugin_slug }}' ),
                'choose_from_most_used'      => __( 'Choose from most used class_plural_upper_name', '{{ plugin_slug }}' ),
