<?php
namespace PrefixCmd\Make\Taxonomies\NotHieralchical;

use Exception;
use PrefixCmd\Make\MakerBase;

class NotHieralchical extends MakerBase
{
    public static function create_custom_not_hieralchical_taxonomy(): void
    {
        ...
        $source_dir      = 'cmd/Make/Taxonomies/NotHieralchical/source';
