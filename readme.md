...
- **src (Source)::** Contiene las clases de PHP que desarrollarás para añadir las funcionalidades de tu plugin a la web en la que se instale el mismo.
    ...
    - **Settings:** La mayoría de plugins o temas incorporan una página de ajustes en la que poder configurar parámetros, incluir claves,... Aunque WordPress tiene sus propias funciones para añadir páginas de ajustes, en esta ocasión la he desarrollado con la función "acf_add_options_page" que incorpora la versión PRO del plugin Advanced Custom Fields, ya que facilita mucho esta labor. En esta carpeta, podrás crear tu propia página de ajustes y asignarle los campos y opciones que creas necesarios para tu plugin.
